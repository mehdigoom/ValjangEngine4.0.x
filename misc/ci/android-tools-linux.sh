...
BASH_RC=~/.bashrc
ValjangEngine_BUILD_TOOLS_PATH=./ValjangEngine-dev/build-tools
mkdir -p $ValjangEngine_BUILD_TOOLS_PATH
cd $ValjangEngine_BUILD_TOOLS_PATH
...
ANDROID_SDK_PATH=$ValjangEngine_BUILD_TOOLS_PATH/$ANDROID_SDK_DIR
...
ANDROID_NDK_PATH=$ValjangEngine_BUILD_TOOLS_PATH/$ANDROID_NDK_DIR
