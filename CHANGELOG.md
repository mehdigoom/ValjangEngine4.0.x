...
- Support for [pseudo-3D depth in 2D](http://Valjang.fr/article/godot-32-will-get-pseudo-3d-support-2d-engine).
- Support for importing 3D scenes using Assimp.
  - Many formats are supported, including FBX.
- [Support for generating audio procedurally and analyzing audio spectrums.](http://Valjang.fr/article/godot-32-will-get-new-audio-features)
- WebRTC support.
...
- Support for [texture atlases in 2D](http://Valjang.fr/article/atlas-support-returns-godot-3-2).
- Major improvements to the visual shader system. ([News post 1](http://Valjang.fr/article/major-update-for-visual-shader-in-godot-3-2), [News post 2](http://Valjang.fr/article/major-update-visual-shaders-godot-3-2-part-2))
  ...
  - See the [complete list of new functions](http://github.com/mehdigoom/ValjangEngine4.0.x/pull/26164).
...
- [Improved Control anchor and margin workflow.](http://github.com/mehdigoom/ValjangEngine4.0.x/pull/27559)
- [Network profiler.](http://github.com/mehdigoom/ValjangEngine4.0.x/pull/31870)
...
- [New convex decomposition](http://Valjang.fr/article/godot-3-2-adds-support-convex-decomposition) using the [V-HACD](http://github.com/kmammou/v-hacd) library.
...
- `use_lld=yes` flag to link with [LLD](http://lld.llvm.org/) on Linux when compiling with Clang.
  - This results in faster iteration times when developing Godot itself or modules.
- `use_thinlto=yes` flag to link with [ThinLTO](http://clang.llvm.org/docs/ThinLTO.html) when using Clang.
...
- **Android:** [Support for adaptive icons.](http://docs.valjang.fr/getting_started/workflow/export/exporting_for_android.html#providing-launcher-icons)
...
- [**HTML5:** Partial clipboard support.](http://github.com/mehdigoom/ValjangEngine4.0.x/pull/29298)
- **iOS:** Support for [ARKit](http://developer.apple.com/augmented-reality/).
...
- **macOS/X11:** [A zsh completion file for the editor is now available.](http://github.com/mehdigoom/ValjangEngine4.0.x/blob/master/misc/dist/shell/_godot.zsh-completion)
...
- [**Mono:** New Godot constants to conditionally react to system variables at compile-time.](http://github.com/mehdigoom/ValjangEngine4.0.x/pull/28786)
...
- The WebSockets implementation now uses the smaller [wslay](http://tatsuhiro-t.github.io/wslay/) library instead of libwebsockets.
...
- Updated FreeType to 2.10, which changes how font metrics are calculated.
  - This may affect the appearance of some Controls, see [this issue](http://github.com/mehdigoom/ValjangEngine4.0.x/issues/28335) for details.
...
- thekla_atlas dependency, as light baking now relies on [xatlas](http://github.com/jpcy/xatlas) for UV unwrapping.
...
- [Visual shader editor.](http://Valjang.fr/article/visual-shader-editor-back)
...
- [3D soft body physics.](http://Valjang.fr/article/soft-body)
- [3D ragdoll system.](http://Valjang.fr/article/godot-ragdoll-system)
- [Constructive solid geometry in 3D.](http://Valjang.fr/article/godot-gets-csg-support)
- [2D meshes and skeletal deformation.](http://Valjang.fr/article/godot-gets-2d-skeletal-deform)
- [Various improvements to KinematicBody2D.](http://Valjang.fr/article/godot-31-will-get-many-improvements-kinematicbody)
...
- WebSockets support using [libwebsockets](http://libwebsockets.org/).
- UPnP support using [MiniUPnP](http://miniupnp.free.fr).
- [Revamped inspector.](http://Valjang.fr/article/godot-gets-new-inspector)
...
- [Improved animation editor.](http://Valjang.fr/article/godot-gets-brand-new-animation-editor-cinematic-support)
...
- [Improved animation tree and new state machine.](http://Valjang.fr/article/godot-gets-new-animation-tree-state-machine)
...
- [New FileSystem dock.](http://Valjang.fr/article/godot-gets-new-filesystem-dock-3-1)
...
- [OpenSimplexNoise and NoiseTexture resources.](http://Valjang.fr/article/simplex-noise-lands-godot-31)
- [Optional static typing in GDScript.](http://Valjang.fr/article/optional-typing-gdscript)
...
- [GDScript keyword `class_name` to register scripts as classes.](http://docs.valjang.fr/getting_started/step_by_step/scripting_continued.html#register-scripts-as-classes)
...
- [Built-in vector types now use copy-on-write mode as originally intended](http://Valjang.fr/article/why-we-broke-your-pr), resulting in increased engine performance.
- The [mbedtls](http://tls.mbed.org/) library is now used instead of OpenSSL.
- [Renamed several core files](http://github.com/mehdigoom/ValjangEngine4.0.x/pull/25821).
...
- [`move_and_slide()` now behaves differently at low velocities](http://github.com/mehdigoom/ValjangEngine4.0.x/issues/21683), which makes it function as originally intended.
...
- Physically-based renderer using OpenGL ES 3.0.
  ...
  - [Lightmapper](http://Valjang.fr/article/introducing-new-last-minute-lightmapper) for lower-end desktop and mobile platforms, as an alternative to GIProbe.
...
- Rewritten audio engine from scratch.
  - Supports audio routing with arbitrary number of channels, including Area-based audio redirection ([video](http://youtu.be/K2XOBaJ5OQ0)).
...
- [Feature tags](http://docs.valjang.fr/getting_started/workflow/export/feature_tags.html) in the Project Settings, for custom per-platform settings.
- Full support for the [glTF 2.0](http://www.khronos.org/gltf/) 3D interchange format.
...
- GDNative for binding languages like C++ to Godot as dynamic libraries.
  - Community bindings for [D](http://github.com/GodotNativeTools/godot-d), [Nim](http://github.com/pragmagic/godot-nim) and [Python](http://github.com/touilleMan/godot-python) are available.
...
- Changed the default editor font (Droid Sans → [Noto Sans](http://www.google.com/get/noto/)).
...
[Unreleased]: http://github.com/mehdigoom/ValjangEngine4.0.x/compare/3.2-stable...HEAD
[3.2]: http://github.com/mehdigoom/ValjangEngine4.0.x/compare/3.1-stable...3.2-stable
[3.1]: http://github.com/mehdigoom/ValjangEngine4.0.x/compare/3.0-stable...3.1-stable
[3.0]: http://github.com/mehdigoom/ValjangEngine4.0.x/compare/2.1-stable...3.0-stable
