...
- Major improvements to the visual shader system. ([News post 1](http://Valjang.fr/article/major-update-for-visual-shader-in-godot-3-2), [News post 2](http://Valjang.fr/article/major-update-visual-shaders-godot-3-2-part-2))
  ...
  - See the [complete list of new functions](https://github.com/mehdigoom/ValjangEngine4.0.x/pull/26164).
...
- [Improved Control anchor and margin workflow.](https://github.com/mehdigoom/ValjangEngine4.0.x/pull/27559)
- [Network profiler.](https://github.com/mehdigoom/ValjangEngine4.0.x/pull/31870)
...
- [New convex decomposition](http://Valjang.fr/article/godot-3-2-adds-support-convex-decomposition) using the [V-HACD](https://github.com/kmammou/v-hacd) library.
...
- [**HTML5:** Partial clipboard support.](https://github.com/mehdigoom/ValjangEngine4.0.x/pull/29298)
...
- **macOS/X11:** [A zsh completion file for the editor is now available.](https://github.com/mehdigoom/ValjangEngine4.0.x/blob/master/misc/dist/shell/_godot.zsh-completion)
...
- [**Mono:** New Godot constants to conditionally react to system variables at compile-time.](https://github.com/mehdigoom/ValjangEngine4.0.x/pull/28786)
...
- Updated FreeType to 2.10, which changes how font metrics are calculated.
  - This may affect the appearance of some Controls, see [this issue](https://github.com/mehdigoom/ValjangEngine4.0.x/issues/28335) for details.
...
- [Renamed several core files](https://github.com/mehdigoom/ValjangEngine4.0.x/pull/25821).
...
- [`move_and_slide()` now behaves differently at low velocities](https://github.com/mehdigoom/ValjangEngine4.0.x/issues/21683), which makes it function as originally intended.
...
[Unreleased]: https://github.com/mehdigoom/ValjangEngine4.0.x/compare/3.2-stable...HEAD
[3.2]: https://github.com/mehdigoom/ValjangEngine4.0.x/compare/3.1-stable...3.2-stable
[3.1]: https://github.com/mehdigoom/ValjangEngine4.0.x/compare/3.0-stable...3.1-stable
[3.0]: https://github.com/mehdigoom/ValjangEngine4.0.x/compare/2.1-stable...3.0-stable
